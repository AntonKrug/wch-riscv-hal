...
namespace peripheral::rcc {
    ...
    struct Rstsckr { // NOLINT
        ...
        enum class PINRSTF_RO_ExternalManualResetFlag: std::uint32_t { // NOLINT
            field_bit_mask   = 0b1U << 26U, // not holding any settings or value, it's a bitmask for this specific field
            field_access    = soc::reg::field_access_right::ReadOnly,
        ...
        enum class PORRSTF_RO_PowerUpDownResetFlag: std::uint32_t { // NOLINT
            field_bit_mask   = 0b1U << 27U, // not holding any settings or value, it's a bitmask for this specific field
            field_access    = soc::reg::field_access_right::ReadOnly,
        ...
        enum class IWDGRSTF_RO_IndependentWatchdogResetFlag: std::uint32_t { // NOLINT
            field_bit_mask   = 0b1U << 29U, // not holding any settings or value, it's a bitmask for this specific field
            field_access    = soc::reg::field_access_right::ReadOnly,
        ...
        enum class WWDGRSTF_RO_WindowWatchdogResetFlag: std::uint32_t { // NOLINT
            field_bit_mask   = 0b1U << 30U, // not holding any settings or value, it's a bitmask for this specific field
            field_access    = soc::reg::field_access_right::ReadOnly,
        ...
        enum class LPWRRSTF_RO_LowPowerResetFlag: std::uint32_t { // NOLINT
            field_bit_mask   = 0b1U << 31U, // not holding any settings or value, it's a bitmask for this specific field
            field_access    = soc::reg::field_access_right::ReadOnly,
